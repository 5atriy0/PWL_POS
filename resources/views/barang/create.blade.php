    ...
    <div class="card-body">
      <form method="POST" action="{{ url('barang') }}" class="form-horizontal">
        ...
        <div class="form-group row">
          ...
          <div class="col-11">
            <input type="text" class="form-control" id="barang_kode" name="barang_kode" value="{{ old('barang_kode') }}" required style="text-transform: uppercase;">
            @error('barang_kode')
              <small class="form-text text-danger">{{ $message }}</small>
            @enderror
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-11">
            <input type="text" class="form-control" id="barang_nama" name="barang_nama" value="{{ old('barang_nama') }}" required style="text-transform: capitalize;">
            @error('barang_nama')
              <small class="form-text text-danger">{{ $message }}</small>
            @enderror
          </div>
